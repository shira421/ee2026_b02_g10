...
HD_PWD='C:/My-Work/NUS/Y2S1/EE2026/Project/Basic-Tasks/project-poly/project-poly.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_oled_calculator_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dual_oled_calculator_top.tcl -notrace
