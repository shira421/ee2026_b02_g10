        ...
        // Graph 1 (y=14-21)
            ...
            case (graph1_type)
                ...
                COSINE: begin
                    ...
                    // Coeff A with negative support (before cos)
                    if (current_graph_slot == 0 && current_coeff_pos == 0 && digit_count > 0) begin
                        if (is_negative) begin
                    ...
                    if (is_pixel_in_char(x, y, 62, 14, "9")) pixel_color = COLOR_WHITE;
                    if (is_pixel_in_char(x, y, 68, 14, "X")) pixel_color = COLOR_WHITE;
                    if (is_pixel_in_char(x, y, 74, 14, ")")) pixel_color = COLOR_WHITE;
                end
                ...
                SINE: begin
                    ...
                    // Coeff A with negative support (before sin)
                    if (current_graph_slot == 0 && current_coeff_pos == 0 && digit_count > 0) begin
                        if (is_negative) begin
                            if (is_pixel_in_char(x, y, 26, 14, "-")) pixel_color = COLOR_WHITE;
                            if (is_pixel_in_char(x, y, 32, 14, digit_to_ascii(temp_coeff))) pixel_color = COLOR_WHITE;
        ...
        // Graph 2 (y=26-33) - Similar pattern with negative support
            ...
            case (graph2_type)
                ...
                COSINE: begin
                    ...
                    if (is_pixel_in_char(x, y, 62, 26, "9")) pixel_color = COLOR_WHITE;
                    if (is_pixel_in_char(x, y, 68, 26, "X")) pixel_color = COLOR_WHITE;
                    if (is_pixel_in_char(x, y, 74, 26, ")")) pixel_color = COLOR_WHITE;
                end
