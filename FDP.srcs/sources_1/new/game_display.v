...
//                    if (result >= 100) begin
//                        if (x_pos >= 57 && x_pos < 62) begin cur_char = "0" + (result / 100); char_col = x_pos - 57; end
//                        else if (x_pos >= 62 && x_pos < 67) begin cur_char = "0" + ((result % 100) / 10); char_col = x_pos - 62; end
//                        else if (x_pos >= 67 && x_pos < 72) begin cur_char = "0" + (result % 10); char_col = x_pos - 67; end
...
//                // Score display with "SCORE:" label
//                if (y_pos >= 34 && y_pos <= 40) begin
//                    char_row = y_pos - 34;
//                    if (x_pos >= 20 && x_pos < 25) begin cur_char = "S"; char_col = x_pos - 20; end
//                    else if (x_pos >= 26 && x_pos < 31) begin cur_char = "C"; char_col = x_pos - 26; end
//                    else if (x_pos >= 32 && x_pos < 37) begin cur_char = "O"; char_col = x_pos - 32; end
//                    else if (x_pos >= 38 && x_pos < 43) begin cur_char = "R"; char_col = x_pos - 38; end
//                    else if (x_pos >= 44 && x_pos < 49) begin cur_char = "E"; char_col = x_pos - 44; end
//                    else if (x_pos >= 50 && x_pos < 55) begin cur_char = ":"; char_col = x_pos - 50; end
//                    else if (x_pos >= 58 && x_pos < 63) begin cur_char = "0" + score; char_col = x_pos - 58; end
    ...
    always @(*) begin
        ...
        case (game_state)
            ...
            PLAYING: begin
                ...
                // Score display at top - handles double digits
                if (y_pos >= 2 && y_pos <= 8) begin
                    char_row = y_pos - 2;
                    if (x_pos >= 30 && x_pos < 35) begin cur_char = "S"; char_col = x_pos - 30; end
                    else if (x_pos >= 36 && x_pos < 41) begin cur_char = "C"; char_col = x_pos - 36; end
                    ...
                    // Display score with proper digit handling
                    else if (score >= 10) begin
                        // 2 digits
                        if (x_pos >= 66 && x_pos < 71) begin cur_char = "0" + (score / 10); char_col = x_pos - 66; end
                        else if (x_pos >= 71 && x_pos < 76) begin cur_char = "0" + (score % 10); char_col = x_pos - 71; end
                    end else begin
                        // 1 digit
                        if (x_pos >= 68 && x_pos < 73) begin cur_char = "0" + score; char_col = x_pos - 68; end
                    end
...
// Replace the GAME_OVER case in your always @(*) block with this:
            ...
            GAME_OVER: begin
                ...
                // Score display with "SCORE:" label - handles double digits
                if (y_pos >= 34 && y_pos <= 40) begin
                    char_row = y_pos - 34;
                    if (x_pos >= 20 && x_pos < 25) begin cur_char = "S"; char_col = x_pos - 20; end
                    else if (x_pos >= 26 && x_pos < 31) begin cur_char = "C"; char_col = x_pos - 26; end
                    ...
                    // Display final_score with proper digit handling
                    else if (final_score >= 10) begin
                        // 2 digits
                        if (x_pos >= 56 && x_pos < 61) begin cur_char = "0" + (final_score / 10); char_col = x_pos - 56; end
                        else if (x_pos >= 61 && x_pos < 66) begin cur_char = "0" + (final_score % 10); char_col = x_pos - 61; end
                    end else begin
                        // 1 digit
                        if (x_pos >= 58 && x_pos < 63) begin cur_char = "0" + final_score; char_col = x_pos - 58; end
                    end
