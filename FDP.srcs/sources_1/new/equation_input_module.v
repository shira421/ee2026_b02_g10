...
//    output reg [7:0] g1_poly_coeff_a, g1_poly_coeff_b, g1_poly_coeff_c,
//    output reg [7:0] g1_cos_coeff_a,
//    output reg [7:0] g1_sin_coeff_a,
    
//    // Outputs for Graph 2's coefficients
//    output reg [7:0] g2_poly_coeff_a, g2_poly_coeff_b, g2_poly_coeff_c,
//    output reg [7:0] g2_cos_coeff_a,
//    output reg [7:0] g2_sin_coeff_a
//);
...
//                    temp_coeff <= keypad_input;  // Direct assignment, no multiplication
//                    digit_count <= 2'd1;
//                end
